...
$FileName = "C:\vagrant\clientlinux\provision\alfresco_cfg\cifsclientlinux.keytab"
if (Test-Path $FileName) {
  Remove-Item $FileName
}

$FileName = "C:\vagrant\clientlinux\provision\alfresco_cfg\httpclientlinux.keytab"
if (Test-Path $FileName) {
  Remove-Item $FileName
}

cp .\cifsclientlinux.keytab C:\vagrant\provision\clientlinux\provision\alfresco_cfg\
cp .\httpclientlinux.keytab C:\vagrant\provision\clientlinux\provision\alfresco_cfg\
